...
% Likelihood ratios observed on the non-permuted data were adjusted to control family-wise error rate by mapping them through the the cumulative distribution function of the fitted extreme value density \citep{Dudbridge2004}[CompanionB].
